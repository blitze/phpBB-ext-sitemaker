(window.webpackJsonp=window.webpackJsonp||[]).push([["blocks/edit"],{"/Mqp":function(t,e,i){},"5uNC":function(t,e,i){"use strict";i.r(e),function(t){i.d(e,"default",(function(){return r}));var a=i("Hpxi");function n(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}var s=window.lang;function r(e,i){var r;Object(a.a)("#dialog-confirm",{autoOpen:!0,buttons:(r={},n(r,s.remove,(function(){t(this).dialog("close"),e.removeBlock(i)})),n(r,s.cancel,(function(){t(this).dialog("close")})),r)})}}.call(this,i("xeH2"))},CLPZ:function(t,e,i){"use strict";(function(t){function a(e,i){var a,n=i.initCodeMirror,s=i.insertText;e.dialog({open:function(){a=n("#class_editor",{theme:"default",lineWrapping:!0,indentWithTabs:!1,lineNumbers:!1,allowFullScreen:!1,actionBtnsSelector:".sm-class-editor-button"})},close:function(){e.off("click",".class-cat"),e.off("click",".transform")}}),e.on("click",".class-cat",(function(e){e.preventDefault();var i=t(this).attr("href"),a=t("#classes-scroller");a.stop().animate({scrollTop:a.scrollTop()+t(i).position().top},1e3)})).on("click",".transform",(function(e){e.preventDefault(),s(a,t(this).text())}))}i.d(e,"a",(function(){return a}))}).call(this,i("xeH2"))},"EJ/s":function(t,e,i){},nnQl:function(t,e,i){"use strict";i.r(e),function(t){i.d(e,"default",(function(){return g}));i("pVw5"),i("Bzvo"),i("Fgwx"),i("/Mqp");var a=i("Hpxi"),n=i("CLPZ"),s=i("lPo6"),r=i("gCDv");i("EJ/s");function o(t,e){if(null==t)return{};var i,a,n=function(t,e){if(null==t)return{};var i,a,n={},s=Object.keys(t);for(a=0;a<s.length;a++)i=s[a],e.indexOf(i)>=0||(n[i]=t[i]);return n}(t,e);if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);for(a=0;a<s.length;a++)i=s[a],e.indexOf(i)>=0||Object.prototype.propertyIsEnumerable.call(t,i)&&(n[i]=t[i])}return n}function l(t,e){return function(t){if(Array.isArray(t))return t}(t)||function(t,e){if(!(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t)))return;var i=[],a=!0,n=!1,s=void 0;try{for(var r,o=t[Symbol.iterator]();!(a=(r=o.next()).done)&&(i.push(r.value),!e||i.length!==e);a=!0);}catch(t){n=!0,s=t}finally{try{a||null==o.return||o.return()}finally{if(n)throw s}}return i}(t,e)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}function c(t,e){var i=Object.keys(t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);e&&(a=a.filter((function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable}))),i.push.apply(i,a)}return i}function h(t){for(var e=1;e<arguments.length;e++){var i=null!=arguments[e]?arguments[e]:{};e%2?c(i,!0).forEach((function(e){u(t,e,i[e])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(i)):c(i).forEach((function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(i,e))}))}return t}function u(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}var d=window,b=d.actions,f=d.config,p=d.lang;function g(e,c){var d,g,v,_={block:{}};function m(){return Object(s.b)(d.find("#edit_form").serializeArray())}function y(){t(this).dialog("widget").find(".ui-dialog-buttonpane").prepend('<label class="dialog-check-button">\n\t\t\t\t\t<input id="update-similar" type="checkbox" /> '.concat(p.updateSimilar,"\n\t\t\t\t</label>"))}g=t(document),(d=new a.a("#dialog-edit",{create:y,beforeClose:function(){r.a.render(e,_)},buttons:(v={},u(v,p.edit,(function(){var e,i;e=d.dialog("widget").find("#update-similar:checked").length,i=h({},m(),{route:f.route,similar:e}),g.trigger({type:"blitze_sitemaker_save_block_before",data:i}),t.post(b.save_block,i).done((function(e){e.list&&(d.dialog("close"),t.each(e.list,(function(e,i){return r.a.render(t("#block-".concat(i.id)),{block:i})})))}))})),u(v,p.cancel,(function(){t(this).dialog("close")})),v)})).on("dialogopen",(function(){var a=this;t(this).find(".sm-multi-input-ui").length&&i.e("blocks/multiInput/input").then(i.bind(null,"2Zbq")).then((function(){return t(".sm-multi-input-ui").multiInputUI()})),t(this).find("#sm-feed-template").length&&Promise.all([i.e("twig/twig").then(i.t.bind(null,"uorI",7)),Promise.all([i.e("codemirror/codemirror"),i.e("blocks/feeds/feeds")]).then(i.bind(null,"ibO7"))]).then((function(e){var i=l(e,2),n=i[0].default;return(0,i[1].default)(t(a),n,c)})),t(this).find(".code-editor").each((function(e,i){var a=t(i),n=a.attr("id");if(!a.next().hasClass("CodeMirror")){var s=a.data(),r=s.width,l=void 0===r?"100%":r,u=s.height,d=void 0===u?100:u,b=o(s,["width","height"]);c.initCodeMirror("#".concat(n),h({actionBtnsSelector:".".concat(n,"-button")},b)).setSize(l,d)}})),d.find(".sortable").sortable({axis:"y",containment:"parent",classes:{"ui-sortable-handle":"panel"}}).disableSelection(),d.find(".block-preview").off().change((function(){return t=m(),i=h({},_,{block:h({},_.block,{},t)}),void r.a.render(e,i);var t,i}))})),function(e){t.getJSON(b.edit_block,{id:e}).done((function(e){if(_.block=e,e.form){var i=e.title.replace(/(<([^>]+)>)/gi,"");d.dialog("option","title","".concat(p.edit," - ").concat(i)),d.html(e.form),d.find("#block-settings").tabs(),d.find(".sm-toggler").click((function(e){e.preventDefault();var i=t(e.currentTarget).data("target");t(i).slideToggle()})).each((function(){t(t(this).data("target")).hide()})),d.find("select[data-togglable-settings]").each((function(){var e=t(this);e.change((function(){return window.phpbb.toggleSelectSettings(e)})),window.phpbb.toggleSelectSettings(e)})),d.dialog("open")}}))}(e.attr("id").substring(6)),d.find("select[data-togglable-settings]").each((function(){var e=t(this);e.change((function(){return window.phpbb.toggleSelectSettings(e)})),window.phpbb.toggleSelectSettings(e)})),Object(n.a)(d,c)}}.call(this,i("xeH2"))},pVw5:function(t,e,i){var a,n,s;
/*!

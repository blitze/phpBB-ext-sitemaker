(window.webpackJsonp=window.webpackJsonp||[]).push([[3],{"/Mqp":function(t,e,i){},"5uNC":function(t,e,i){"use strict";i.r(e),function(t){i.d(e,"default",function(){return r});var a=i("Hpxi");function n(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}var s=window.lang;function r(e,i){var r;Object(a.a)("#dialog-confirm",{autoOpen:!0,buttons:(r={},n(r,s.remove,function(){t(this).dialog("close"),e.removeBlock(i)}),n(r,s.cancel,function(){t(this).dialog("close")}),r)})}}.call(this,i("xeH2"))},CLPZ:function(t,e,i){"use strict";(function(t){function a(e,i){var a,n=i.initCodeMirror,s=i.insertText;e.dialog({open:function(){a=n("#class_editor",{theme:"default",lineWrapping:!0,indentWithTabs:!1,lineNumbers:!1,allowFullScreen:!1,actionBtnsSelector:".sm-class-editor-button"})}}),e.on("click",".class-cat",function(e){e.preventDefault();var i=t(this).attr("href"),a=t("#classes-scroller");a.animate({scrollTop:a.scrollTop()+t(i).position().top},1e3)}).on("click",".transform",function(e){e.preventDefault(),s(a,t(this).text())})}i.d(e,"a",function(){return a})}).call(this,i("xeH2"))},"EJ/s":function(t,e,i){},nnQl:function(t,e,i){"use strict";i.r(e),function(t){i.d(e,"default",function(){return f});i("pVw5"),i("Bzvo"),i("Fgwx"),i("/Mqp");var a=i("Hpxi"),n=i("CLPZ"),s=i("lPo6"),r=i("gCDv");i("EJ/s");function o(t,e){return function(t){if(Array.isArray(t))return t}(t)||function(t,e){var i=[],a=!0,n=!1,s=void 0;try{for(var r,o=t[Symbol.iterator]();!(a=(r=o.next()).done)&&(i.push(r.value),!e||i.length!==e);a=!0);}catch(t){n=!0,s=t}finally{try{a||null==o.return||o.return()}finally{if(n)throw s}}return i}(t,e)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}function l(t){for(var e=1;e<arguments.length;e++){var i=null!=arguments[e]?arguments[e]:{},a=Object.keys(i);"function"==typeof Object.getOwnPropertySymbols&&(a=a.concat(Object.getOwnPropertySymbols(i).filter(function(t){return Object.getOwnPropertyDescriptor(i,t).enumerable}))),a.forEach(function(e){h(t,e,i[e])})}return t}function h(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t}var c=window,u=c.actions,d=c.config,b=c.lang;function f(e,c){var f,g,v,p={block:{}};function _(){return Object(s.b)(f.find("#edit_form").serializeArray())}function m(){t(this).dialog("widget").find(".ui-dialog-buttonpane").prepend('<label class="dialog-check-button">\n\t\t\t\t\t<input id="update-similar" type="checkbox" /> \n\t\t\t\t\t'.concat(b.updateSimilar,"\n\t\t\t\t</label>"))}g=t(document),(f=new a.a("#dialog-edit",{create:m,beforeClose:function(){r.a.render(e,p)},buttons:(v={},h(v,b.edit,function(){var e,i;e=f.dialog("widget").find("#update-similar:checked").length,i=l({},_(),{route:d.route,similar:e}),g.trigger({type:"blitze_sitemaker_save_block_before",data:i}),t.post(u.save_block,i).done(function(e){e.list&&(f.dialog("close"),t.each(e.list,function(e,i){return r.a.render(t("#block-".concat(i.id)),{block:i})}))})}),h(v,b.cancel,function(){t(this).dialog("close")}),v)})).on("change",".block-preview",function(){return t=_(),i=l({},p,{block:l({},p.block,t)}),void r.a.render(e,i);var t,i}),f.on("dialogopen",function(){var e=this;t(this).find(".sm-multi-input").length&&i.e(6).then(i.bind(null,"2Zbq")).then(function(t){return(0,t.default)()}),t(this).find("#sm-feed-template").length&&Promise.all([i.e(2).then(i.t.bind(null,"uorI",7)),Promise.all([i.e(1),i.e(2),i.e(4)]).then(i.bind(null,"ibO7"))]).then(function(i){var a=o(i,2),n=a[0].default;return(0,a[1].default)(t(e),n,c)})}),function(e){t.getJSON(u.edit_block,{id:e}).done(function(e){if(p.block=e,e.form){var i=e.title.replace(/(<([^>]+)>)/gi,"");f.dialog("option","title","".concat(b.edit," - ").concat(i)),f.html(e.form),f.find("#block-settings").tabs(),f.find(".sm-toggler").click(function(e){e.preventDefault();var i=t(e.currentTarget).data("target");t(i).slideToggle()}).each(function(){t(t(this).data("target")).hide()}),f.find("select[data-togglable-settings]").each(function(){var e=t(this);e.change(function(){return window.phpbb.toggleSelectSettings(e)}),window.phpbb.toggleSelectSettings(e)}),f.dialog("open")}})}(e.attr("id").substring(6)),f.find("select[data-togglable-settings]").each(function(){var e=t(this);e.change(function(){return window.phpbb.toggleSelectSettings(e)}),window.phpbb.toggleSelectSettings(e)}),Object(n.a)(f,c)}}.call(this,i("xeH2"))},pVw5:function(t,e,i){var a,n,s;
/*!

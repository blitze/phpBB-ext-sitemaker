(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tree/group"],{
  ...
  $.ajaxSetup({
    ...
    complete: function complete(_ref) {
      ...
      if (sitemakerRequest) {
        ...
        if (responseJSON && (responseJSON.message || responseJSON.MESSAGE_TEXT)) {
...
function Dialog(selector) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return $(selector).dialog(_objectSpread(_objectSpread({}, defOptions), options));
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "jquery")))
...
/***/ "./develop/components/TreeGroup/AddGroup/index.js":
/*!********************************************************!*\
  !*** ./develop/components/TreeGroup/AddGroup/index.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AddGroup; });
...
var _window = window,
    ...
    lang = _window.lang;
function AddGroup($groups, actions) {
  Object(_Button_button__WEBPACK_IMPORTED_MODULE_0__["default"])('#add-group', {}, function (e) {
    e.stopImmediatePropagation();
    $.post("".concat(config.ajaxUrl).concat(actions.add)).done(function (_ref) {
      var id = _ref.id,
          title = _ref.title;

      if (id > 0) {
        var $item = $("<li id=\"group-".concat(id, "\" class=\"group-item\">\n\t\t\t\t\t\t<a href=\"#\" class=\"group-option\">\n\t\t\t\t\t\t\t<span class=\"group-title\">").concat(title, "</span>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t\t<div class=\"group-actions\">\n\t\t\t\t\t\t\t<a href=\"#\" class=\"group-edit left\" title=\"").concat(lang.edit, "\">\n\t\t\t\t\t\t\t\t<i class=\"fa fa-cog\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t<a href=\"#\" class=\"group-delete left\" title=\"").concat(lang.remove, "\">\n\t\t\t\t\t\t\t\t<i class=\"fa fa-times\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</li>"));
        $groups.append($item);
        $item.trigger('click');
      }
    });
...
/***/ "./develop/components/TreeGroup/DeleteGroup/index.js":
/*!***********************************************************!*\
  !*** ./develop/components/TreeGroup/DeleteGroup/index.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DeleteGroup; });
...
var _window = window,
    config = _window.config,
    lang = _window.lang;
function DeleteGroup($groups, actions, initTree) {
  var _buttons;

  var $currentGroup;

  var deleteGroup = function deleteGroup() {
    $.post("".concat(config.ajaxUrl).concat(actions.remove)).done(function () {
      if ($currentGroup.siblings('.group-item').length) {
        var $selected = $currentGroup.prev('.group-item').length ? $currentGroup.prev() : $currentGroup.next();
  ...
  var confirm = new _Dialog__WEBPACK_IMPORTED_MODULE_0__["default"]('#dialog-confirm-delete-group', {
  ...
  $groups.on('click', '.group-delete', function (e) {
    e.preventDefault();
    confirm.dialog('open');
...
/***/ "./develop/components/TreeGroup/EditGroup/index.js":
/*!*********************************************************!*\
  !*** ./develop/components/TreeGroup/EditGroup/index.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EditGroup; });
/* harmony import */ var _InlineEditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../InlineEditor */ "./develop/components/InlineEditor/index.js");

var _window = window,
    config = _window.config,
    lang = _window.lang;
function EditGroup(actions) {
  var handleTitleUpdate = function handleTitleUpdate(e) {
    var idAttr = $(e.currentTarget).closest('.group-item').attr('id');
    var id = idAttr.substring(6);
    var title = e.currentTarget.value;
    $.post("".concat(config.ajaxUrl).concat(actions.edit), {
      id: id,
      title: title
    }).done(function (result) {
      $("#".concat(idAttr)).find('.group-title').text(result.name);
    });
    return lang.processing;
  };

  Object(_InlineEditor__WEBPACK_IMPORTED_MODULE_0__["default"])('.group-edit', handleTitleUpdate, function (e) {
    return $(e.currentTarget).closest('.group-item').find('.group-title');
  });
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "jquery")))
...
/***/ "./develop/components/TreeGroup/index.js":
/*!***********************************************!*\
  !*** ./develop/components/TreeGroup/index.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _entries_publicPath__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../entries/publicPath */ "./develop/entries/publicPath.js");
/* harmony import */ var _Ajax_setup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Ajax/setup */ "./develop/components/Ajax/setup.js");
/* harmony import */ var _AddGroup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddGroup */ "./develop/components/TreeGroup/AddGroup/index.js");
/* harmony import */ var _EditGroup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./EditGroup */ "./develop/components/TreeGroup/EditGroup/index.js");
/* harmony import */ var _DeleteGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DeleteGroup */ "./develop/components/TreeGroup/DeleteGroup/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./develop/components/TreeGroup/style.scss");
...
function TreeGroup(_ref) {
  var idKey = _ref.idKey,
      _ref$groupActions = _ref.groupActions,
      groupActions = _ref$groupActions === void 0 ? {} : _ref$groupActions,
      options = _objectWithoutProperties(_ref, ["idKey", "groupActions"]);

  var $loader = $('#loader i');
  var $msgBox = $('#ajax-message');
  var $groups = $('#sm-groups').show();
  var $tree = $('#nested-tree');
  var $treeBuilder;
  ...
  var init = function init(groupId) {
    Object(_Ajax_setup__WEBPACK_IMPORTED_MODULE_1__["default"])($loader, showMessage, "".concat(idKey, "=").concat(groupId));

    if (groupId > 0) {
      $tree.show();

      if (!$treeBuilder) {
        $treeBuilder = $tree.treeBuilder(_objectSpread(_objectSpread({}, options), {}, {
          init: function init() {
            return $tree.treeBuilder('getItems');
          }
        }));
      } else {
  ...
  var $firstTreeGroup = $groups.children('.group-item:first');

  if ($firstTreeGroup.length) {
    groupId = $firstTreeGroup.attr('id').substring(6);
  }

  var actions = _objectSpread(_objectSpread({}, defaultActions), groupActions);

  __webpack_require__.e(/*! import() | tree/builder */ "tree/builder").then(__webpack_require__.bind(null, /*! ../Tree/builder */ "./develop/components/Tree/builder.js")).then(function () {
    init(groupId);
    Object(_AddGroup__WEBPACK_IMPORTED_MODULE_2__["default"])($groups, actions);
    Object(_EditGroup__WEBPACK_IMPORTED_MODULE_3__["default"])(actions);
    Object(_DeleteGroup__WEBPACK_IMPORTED_MODULE_4__["default"])($groups, actions, init);
  });
  $('#groups-loader').hide();
  $('body').on('click', '.group-item', function (e) {
    e.preventDefault(); // eslint-disable-next-line no-alert

    if (!$treeBuilder || !$tree.treeBuilder('isUnsaved') || window.confirm(lang.unsavedChanges) // eslint-disable-line no-alert
    ) {
        groupId = $(e.currentTarget).addClass('row3 current-group').siblings().removeClass('row3 current-group').end().attr('id').substring(6);
        init(groupId);
      }
  });
}
...
/* harmony default export */ __webpack_exports__["default"] = (TreeGroup);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "jquery")))

/***/ }),

/***/ "./develop/components/TreeGroup/style.scss":
/*!*************************************************!*\
  !*** ./develop/components/TreeGroup/style.scss ***!
  \*************************************************/
/*! no static exports found */
...
/* harmony import */ var core_js_modules_esnext_aggregate_error__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/esnext.aggregate-error */ "./node_modules/core-js/modules/esnext.aggregate-error.js");
/* harmony import */ var core_js_modules_esnext_aggregate_error__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_aggregate_error__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var core_js_modules_esnext_promise_all_settled__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/esnext.promise.all-settled */ "./node_modules/core-js/modules/esnext.promise.all-settled.js");
/* harmony import */ var core_js_modules_esnext_promise_all_settled__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_promise_all_settled__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var core_js_modules_esnext_promise_any__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/esnext.promise.any */ "./node_modules/core-js/modules/esnext.promise.any.js");
/* harmony import */ var core_js_modules_esnext_promise_any__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_promise_any__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var core_js_modules_esnext_promise_try__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/esnext.promise.try */ "./node_modules/core-js/modules/esnext.promise.try.js");
/* harmony import */ var core_js_modules_esnext_promise_try__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_promise_try__WEBPACK_IMPORTED_MODULE_7__);
...
__webpack_require__.p = "".concat(window.config.scriptPath, "ext/blitze/sitemaker/styles/all/theme/assets/");

	...
	render() {
		const supportLinks = [
			...
			},
			{
				content: (
					<translate>
						...
						[here](https://www.phpbb.com/customise/db/extension/phpbb_sitemaker_2/support)
					</translate>
				),
			...
			},
			{
				content: (
					<translate>
						Find out what's new with this project on our
						[blog](./blog)
					</translate>
				),
					...
					<div className="post">
						...
						<p>
							<translate desc="statement made to reader">
								This project is maintained by a dedicated group
								of people.
							</translate>
						</p>
						<GridBlock

...
class blocks_test extends base_mapper
{
	...
	public function test_load()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\entity\block', $block);
	...
	public function test_find()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\collections\blocks', $collection);
	...
	public function test_add_block()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\entity\block', $result);

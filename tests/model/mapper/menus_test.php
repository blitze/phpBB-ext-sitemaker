...
class menus_test extends base_mapper
{
	...
	public function test_load()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\entity\menu', $menu);
	...
	public function test_find()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\collections\menus', $collection);
	...
	public function test_save_no_id_provided()
	{
		...
		$this->assertInstanceOf('\blitze\sitemaker\model\entity\menu', $result);

...
$lang = array_merge($lang, array(
	...
	'ADD_BULK_MENU_EXPLAIN'		=> 'Добавить несколько пунктов меню сразу.<br /> - Разместите каждый элемент на отдельной строке<br /> - Используйте клавишу <strong>Tab</strong> для отступа элементов для представления родитель-дочерних отношений<br /> - Введите элемент и URL так, что: Home|index.php',
	...
	'REBUILD_TREE'				=> 'Перестроить дерево',
	'REQUIRED'					=> 'Требуется',
